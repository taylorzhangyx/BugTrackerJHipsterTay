package com.jhipster.taylorzyx.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipster.taylorzyx.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jhipster.taylorzyx.security.DomainUserDetailsService", "createSpringSecurityUser");
